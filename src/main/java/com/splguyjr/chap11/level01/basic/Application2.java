package com.splguyjr.chap11.level01.basic;
...
public class Application2 {
    public static void main(String[] args) {
        ...
        try (FileReader fr = new FileReader(src); FileWriter fw = new FileWriter(dst)) {
            int value;
            ...
            e.printStackTrace();
            System.out.println("오류 : " + src + " (지정된 파일을 찾을 수 없습니다)");
        } catch (IOException e) {

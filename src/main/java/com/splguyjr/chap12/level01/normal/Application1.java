package com.splguyjr.chap12.level01.normal;
...
public class Application1 {
    ...
    public static <T> void swap(T[] genericArray, int idx1, int idx2) {
        T temp = genericArray[idx1];
        genericArray[idx1] = genericArray[idx2];
        genericArray[idx2] = temp;
    }
}

package com.splguyjr.chap99.comprehensive.ui;

import com.splguyjr.chap99.comprehensive.domain.User;
import com.splguyjr.chap99.comprehensive.exception.ExistingLoginSessionException;
import com.splguyjr.chap99.comprehensive.exception.NoLoginSessionException;
import com.splguyjr.chap99.comprehensive.exception.UnregisteredProblemException;
import com.splguyjr.chap99.comprehensive.exception.WrongSubmitCodeException;
import com.splguyjr.chap99.comprehensive.persistence.problem.answer.FileAnswerStorage;
import com.splguyjr.chap99.comprehensive.persistence.problem.checker.FilePathChecker;
import com.splguyjr.chap99.comprehensive.persistence.problem.testcase.FileTestCaseStorage;
import com.splguyjr.chap99.comprehensive.persistence.problem.ProblemRepository;
import com.splguyjr.chap99.comprehensive.persistence.user.FileUserStorage;
import com.splguyjr.chap99.comprehensive.persistence.user.UserRepository;
import com.splguyjr.chap99.comprehensive.service.problem.JudgeService;
import com.splguyjr.chap99.comprehensive.service.problem.ProblemService;
import com.splguyjr.chap99.comprehensive.service.user.UserService;
...
public class Application {
    ...
    private void solveProblem() {
        try {
            ...
            while (!(line = br.readLine()).equals("END")) { // "END" 입력 시 종료
                sb.append(line).append("\n");
            }
